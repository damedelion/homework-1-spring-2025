...
> [!WARNING]
> БАГ. При введение в инпут логина невалидных символов появляется сообщение, которое выходит за пределы инпута логина и имеет нечитаемый (красный на синем фоне) цвет.
...
> [!WARNING]
> БАГ. При введении логина невалидного размера появляется сообщение, которое выходит за пределы инпута логина и имеет нечитаемый (красный на синем фоне) цвет.

...
5. При клике на кнопку "Нравится" авторизованный пользователь добавляет исполнителя к себе в подписки, и после обновления страницы количество подписок на альбом увеличивается на один.
...
### 3.3 Карусель с альбомами исполнителя 
...
### 3.4 Плеер на странице исполнителя

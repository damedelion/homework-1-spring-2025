...
* При перезагрузке страницы последний трек, который играл последний, должен сохраняться.
> [!WARNING]
> БАГ. При перезагрузке страницы последний трек, который играл последний, не сохраняется<br>
